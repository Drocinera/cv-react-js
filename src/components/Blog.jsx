                        ...
                        <div class="card mb-3 border-success mb-3 text-bg-info mb-3" style={{maxWidth: "90em"}}>
                          ...
                          <div class="card mb-3 border-danger mb-3 text-bg-success mb-3" style={{maxWidth: "90em"}}>
                            <div class="row g-0">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  <h5 class="card-title">Optimiser son site pour différent appareils</h5>
                                  <p class="card-text">Suspendisse potenti. Donec in mattis tortor. Nullam viverra risus non tellus pellentesque fringilla. Aliquam sit amet sem quis ante pulvinar dignissim.</p>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="card mb-3 border-info mb-3 text-bg-secondary mb-3" style={{maxWidth: "90em"}}>
                            <div class="row g-0">
                              <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                  <div class="card-body">
                                    <h5 class="card-title">Optimisation pour les recherches internet</h5>
                                    <p class="card-text">Vestibulum lobortis dapibus fermentum. Aenean dolor est, varius sed efficitur aliquet, egestas vitae mauris. Vivamus iaculis, ante at posuere viverra, ligula purus tristique nisl, ut iaculis magna ex quis libero.
                            ...
                            <div class="card mb-3 border-dark mb-3 text-bg-primary mb-3s" style={{maxWidth: "90em"}}>
                              <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                  <div class="card-body">
                                    <h5 class="card-title">Effectuer ses propres formations technologiques</h5>
                                    <p class="card-text">Sed id hendrerit leo. Aenean quis elit eget mi tempus egestas. Praesent rutrum urna sed scelerisque vulputate. 
